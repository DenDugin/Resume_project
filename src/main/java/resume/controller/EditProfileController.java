...
import resume.component.FormErrorConverter;
import resume.entity.Contacts;
import resume.entity.Profile;
import resume.exception.FormValidationException;
import resume.form.CertificateForm;
import resume.form.CourseForm;
import resume.form.EducationForm;
import resume.form.InfoForm;
import resume.form.LanguageForm;
import resume.form.PasswordForm;
import resume.form.PracticForm;
...
public class EditProfileController {
	...
	// для конвертации объектов классов Entity в формы и наоборот
	@InitBinder
