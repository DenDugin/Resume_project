...
import resume.annotation.ProfileDataFieldGroup;
import resume.annotation.ProfileInfoField;
import resume.component.impl.UploadCertificateLinkManager;
...
import resume.entity.ProfileEntity;
import resume.entity.Skill;
import resume.entity.SkillCategory;
import resume.exception.CantCompleteClientRequestException;
import resume.exception.FormValidationException;
...
import resume.repository.storage.AbstractProfileEntityRepository;
import resume.repository.storage.CertificateRepository;
import resume.repository.storage.CourseRepository;
import resume.repository.storage.EducationRepository;
import resume.repository.storage.HobbyRepository;
import resume.repository.storage.LanguageRepository;
import resume.repository.storage.PracticRepository;
import resume.repository.storage.SkillCategoryRepository;
import resume.repository.storage.SkillRepository;
import resume.service.CacheService;
import resume.service.EditProfileService;
import resume.service.ImageProcessorService;
import resume.service.ImageStorageService;
import resume.service.NotificationManagerService;
...
public class EditProfileServiceImpl extends AbstractCreateProfileService implements EditProfileService {
	...
	protected void populateSkillCategories(List<Skill> skills) {
		...
		for (Skill skill : skills) {
			skill.setCategory(map.get(skill.getId()));
		}
	}
	...
	protected <E> void updateIndexProfileEntities(CurrentProfile currentProfile, List<E> updatedData, String collections) {
		...
		// используем рефлекцсию для записи
